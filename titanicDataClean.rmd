...
```{r set_library_to_plot, echo=FALSE, cache=FALSE, results = 'asis', warning=FALSE, comment=FALSE, warning=FALSE}
library(dplyr)
library(data.table)
library(ggplot2)
library(DT)
...
Al final, decidí apliar 'S' a la variable y ver dónde eso nos conduce en el análisis posterior.
